...
# Load the datasets
agriculture_df = pd.read_csv('BubblePlot_Preprocessing.py')
continent_df = pd.read_csv('BubblePlot_Continents_Dataset.csv')
...
cleaned_df.to_csv('Processed_Bubbleplot_Dataset.csv', index=False)